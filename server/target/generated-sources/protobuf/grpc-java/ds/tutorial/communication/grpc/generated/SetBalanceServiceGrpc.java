...
public final class SetBalanceServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "ds.tutorial.communication.grpc.generated.SetBalanceService";
   ...
   */
  public static SetBalanceServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SetBalanceServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SetBalanceServiceBlockingV2Stub>() {
        @java.lang.Override
        public SetBalanceServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new SetBalanceServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return SetBalanceServiceBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void setBalance(ds.tutorial.communication.grpc.generated.SetBalanceRequest request,
  ...
  /**
   * Base class for the server implementation of the service SetBalanceService.
   */
  public static abstract class SetBalanceServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return SetBalanceServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service SetBalanceService.
   */
  public static final class SetBalanceServiceStub
      extends io.grpc.stub.AbstractAsyncStub<SetBalanceServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service SetBalanceService.
   */
  public static final class SetBalanceServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<SetBalanceServiceBlockingV2Stub> {
    private SetBalanceServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected SetBalanceServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new SetBalanceServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service SetBalanceService.
   */
  public static final class SetBalanceServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<SetBalanceServiceBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service SetBalanceService.
   */
  public static final class SetBalanceServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<SetBalanceServiceFutureStub> {
  ...
  private static final class SetBalanceServiceMethodDescriptorSupplier
    ...
    SetBalanceServiceMethodDescriptorSupplier(java.lang.String methodName) {
