...
public final class CheckBalanceServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "ds.tutorial.communication.grpc.generated.CheckBalanceService";
   ...
   */
  public static CheckBalanceServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CheckBalanceServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<CheckBalanceServiceBlockingV2Stub>() {
        @java.lang.Override
        public CheckBalanceServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new CheckBalanceServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return CheckBalanceServiceBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void checkBalance(ds.tutorial.communication.grpc.generated.CheckBalanceRequest request,
  ...
  /**
   * Base class for the server implementation of the service CheckBalanceService.
   */
  public static abstract class CheckBalanceServiceImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return CheckBalanceServiceGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service CheckBalanceService.
   */
  public static final class CheckBalanceServiceStub
      extends io.grpc.stub.AbstractAsyncStub<CheckBalanceServiceStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service CheckBalanceService.
   */
  public static final class CheckBalanceServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<CheckBalanceServiceBlockingV2Stub> {
    private CheckBalanceServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CheckBalanceServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CheckBalanceServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service CheckBalanceService.
   */
  public static final class CheckBalanceServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<CheckBalanceServiceBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service CheckBalanceService.
   */
  public static final class CheckBalanceServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<CheckBalanceServiceFutureStub> {
  ...
  private static final class CheckBalanceServiceMethodDescriptorSupplier
    ...
    CheckBalanceServiceMethodDescriptorSupplier(java.lang.String methodName) {
